...
# ─── RECURSOS POR CCAA ────────────────────────────────────────────────────────
# Organismos, servicios y referencias útiles por comunidad autónoma
RECURSOS_CCAA = {
    "Madrid": [
        ("Agencia de Vivienda Social de Madrid", "avs.madrid.es", "Ayudas, mediación y vivienda pública"),
        ("OFECUM — Oficina de Conciliación", "madrid.es/ofecum", "Mediación previa obligatoria al desahucio (Ley 1/2025)"),
        ("OCU — Organización de Consumidores", "ocu.org", "Asesoría gratuita sobre contratos de alquiler"),
    ...
    "Cataluña": [
        ...
        ("Oficines Locals d'Habitatge", "habitatge.gencat.cat", "Asesoramiento presencial por municipio"),
        ("FACUA Catalunya", "facua.org", "Denuncias por prácticas abusivas en alquiler"),
    ...
    "Andalucía": [
        ...
        ("Consejería de Fomento, Articulación del Territorio y Vivienda", "juntadeandalucia.es/vivienda", "Ayudas y programas de alquiler asequible"),
    ],
    "Comunitat Valenciana": [
        ("Entitat Valenciana d'Habitatge i Sòl (EVha)", "habitatge.gva.es", "Mediación y vivienda asequible"),
        ("Conselleria de Medi Ambient, Territori i Habitatge", "habitatge.gva.es", "Ayudas y programas de alquiler"),
    ...
    "País Vasco": [
        ...
        ("Departamento de Vivienda del Gobierno Vasco", "euskadi.eus/vivienda", "Mediación y ayudas al alquiler"),
        ("KONTSUMOBIDE", "euskadi.eus/kontsumobide", "Servicio vasco del consumidor — mediación"),
    ],
    "Galicia": [
        ("Instituto Galego da Vivenda e Solo (IGVS)", "igvs.xunta.gal", "Mediación y ayudas al alquiler"),
        ("Consellería de Medio Ambiente e Vivenda", "xunta.gal/vivenda", "Programas de alquiler protegido"),
        ("FACUA Galicia", "facua.org", "Asesoría en conflictos de consumo"),
    ],
    "Canarias": [
    ...
    "Aragón": [
        ("Sociedad Municipal de Rehabilitación Urbana (SMRU)", "zaragoza.es/vivienda", "Mediación y vivienda protegida en Zaragoza"),
    ...
    "Castilla y León": [
        ...
        ("Consejo Regional de Consumidores y Usuarios", "jcyl.es/consumo", "Asesoría y arbitraje"),
    ],
    "Castilla-La Mancha": [
        ("Dirección General de Vivienda y Suelo", "castillalamancha.es/vivienda", "Programas de alquiler y mediación"),
        ("Agencia Regional de la Energía y la Vivienda", "jccm.es", "Ayudas al alquiler"),
    ],
    "Asturias": [
        ("Sociedad Regional de Vivienda y Suelo del Principado de Asturias (VIPASA)", "vipasa.es", "Mediación y vivienda pública"),
    ...
    "Cantabria": [
        ...
        ("Oficina del Consumidor de Cantabria (OMIC)", "cantabria.es/consumo", "Asesoría en conflictos de alquiler"),
    ],
    "Extremadura": [
        ("Dirección General de Urbanismo y Ordenación del Territorio", "gobex.es/vivienda", "Vivienda protegida y mediación"),
    ...
    "Navarra": [
        ...
        ("Servicio de Consumo del Gobierno de Navarra", "navarra.es/consumo", "Mediación y arbitraje"),
    ],
    "La Rioja": [
        ("Dirección General de Urbanismo y Vivienda de La Rioja", "larioja.org/vivienda", "Ayudas y mediación en alquiler"),
        ("Servicio de Consumo de La Rioja", "larioja.org/consumo", "Asesoría en conflictos"),
    ],
    "Ceuta/Melilla": [
        ("Ciudad Autónoma de Ceuta — Vivienda", "ceuta.es", "Servicios de vivienda y mediación"),
    ...
    "No especificada": [
        ...
        ("OCU — Organización de Consumidores y Usuarios", "ocu.org", "Asesoría legal gratuita en alquiler"),
        ("FACUA Consumidores en Acción", "facua.org", "Denuncias y defensa del consumidor"),
    ],
}

# Recursos comunes a todas las CCAA
RECURSOS_COMUNES = [
    ("Ministerio de Vivienda y Agenda Urbana", "vivienda.gob.es", "Portal nacional con ayudas y legislación de alquiler"),
    ("Consejo General del Poder Judicial (CGPJ)", "cgpj.es", "Estadísticas de desahucios y juzgados competentes"),
    ("Ley 12/2023 de Vivienda — BOE", "boe.es", "Texto completo de la Ley por el Derecho a la Vivienda"),
    ("Ley Orgánica 1/2025 — Mediación obligatoria", "boe.es", "Desde abril 2025: mediación previa obligatoria antes del desahucio"),
]
...
def generar_pdf(datos_inquilino, prob, factores, label, conclusion,
    ...
    story.append(HRFlowable(width="100%", thickness=0.5, color=colors.HexColor("#e2e8f0"), spaceAfter=8))
    story.append(Paragraph("CLÁUSULAS RECOMENDADAS PARA EL CONTRATO", se_s))
    ...
    clausulas_pdf = [
        ...
        ("Consulta ASNEF/RAI previa", "Riesgo muy alto", "Verificar ficheros de morosos antes de firmar (€5-15)"),
    ]
...
if "candidatos" not in st.session_state:
    st.session_state.candidatos = []  # historial de análisis
...
<div style="text-align:center;padding:2rem 0 1rem 0;">
    ...
    <p style="color:#64748b;font-size:1rem;max-width:420px;margin:0 auto 2rem auto;line-height:1.7;font-weight:300;">
        Desarrollado con fuentes públicas de datos y técnicas de aprendizaje automático
        para ayudarte a tomar mejores decisiones antes de firmar.
    </p>
</div>""", unsafe_allow_html=True)
...
if st.button("Analizar perfil →"):
    if nomina <= 0:
        ...
        # Añadir al historial de candidatos
        st.session_state.candidatos.append({
            "n": len(st.session_state.candidatos) + 1,
            "prob": round(prob*100),
            "label": label,
            "color": (label.split()[0] if label else ""),
            "ccaa": ccaa,
            "contrato": contrato,
...
if "resultado" in st.session_state:
    ...
    with tab1:
        ...
        st.markdown(f'<div style="display:flex;justify-content:center;overflow-x:auto;">{svg_radar}</div>',
                    unsafe_allow_html=True)
    ...
    with tab2:
        ...
        st.markdown(f'<div style="overflow-x:auto;">{svg_bars}</div>',
                    unsafe_allow_html=True)
    ...
    <div style="margin:8px 0 16px 0;">
        <a href="https://certificadosmedicosmadrid.com/conocenos/" target="_blank"
            ...
            <div style="background:linear-gradient(135deg,#0f172a 0%,#1e3a5f 100%);
                ...
                <div>
                    <div style="font-size:0.7rem;letter-spacing:0.12em;text-transform:uppercase;
                                color:#94a3b8;margin-bottom:4px;">Patrocinado</div>
                    <div style="font-size:1rem;font-weight:600;color:white;margin-bottom:2px;">
                        Certificados Médicos Madrid
                    </div>
                    <div style="font-size:0.82rem;color:#94a3b8;">
                        Certificados rápidos para trámites de alquiler y contratos
                    </div>
                </div>
                <div style="background:#00C896;color:#0f172a;padding:8px 16px;
    ...
    email_input = st.text_input("Tu email", placeholder="propietario@ejemplo.com", key="email_lead")
    acepta_comunicaciones = st.checkbox("Acepto recibir actualizaciones y comunicaciones de Predice_Impago", key="chk1")
    acepta_socios = st.checkbox("Acepto compartir mi perfil con socios del sector inmobiliario (Opcional)", key="chk2")
    st.markdown("""<style>
    div[data-testid="stCheckbox"] label span { color: #0f172a !important; font-size:0.88rem !important; font-weight:500 !important; }
    div[data-testid="stCheckbox"] label { color: #0f172a !important; }
    div[data-testid="stCheckbox"] p { color: #0f172a !important; font-weight:500 !important; }
    ...
    if email_input and acepta_comunicaciones:
...
st.markdown("""<div style="text-align:center;padding:1rem 0;">
    <p style="font-size:0.75rem;color:#cbd5e1;line-height:1.6;">
        Predice_Impago · Herramienta orientativa. No constituye asesoramiento legal ni financiero.<br>
