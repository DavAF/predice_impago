...
with col_b: alquiler = st.number_input("Alquiler mensual (€)", min_value=0, max_value=10000, value=int(_prev.get("alquiler",750)), step=50, key="w_alquiler")
with col_a: n_perceptores = st.number_input("Número de perceptores de ingresos", min_value=1, max_value=4, value=1, step=1, key="w_nperc")
