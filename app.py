...
# Estas tablas deben declararse antes de cualquier función/UI que las use.
...
RIESGO_FUENTE = {
    "Nómina": 0.04,
    "Pensión": 0.03,
    "Autónomo / facturación": 0.16,
    "Prestación desempleo": 0.30,
    "Ayudas / subsidios": 0.28,
    "Sin ingresos estables": 0.45,
}

RIESGO_IMPAGOS = {
    "No": 0.00,
    "Retrasos puntuales": 0.12,
    "Sí, impagos anteriores": 0.35,
    "Desconocido": 0.10,
}

CORR_NAC = {
    "Historial bancario completo en España": 0.00,
    "Historial parcial": 0.08,
    "Sin historial bancario en España": 0.15,
}
...
MORA_POR_CCAA = {
    ...
    "Canarias": 0.17,
    "Cantabria": 0.10,
    "Castilla-La Mancha": 0.13,
    "Castilla y León": 0.10,
    "Cataluña": 0.16,
    "Ceuta/Melilla": 0.18,
    "Comunitat Valenciana": 0.15,
    "Extremadura": 0.13,
    "Galicia": 0.10,
    "La Rioja": 0.09,
    "Madrid": 0.12,
